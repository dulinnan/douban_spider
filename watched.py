...
url = 'https://movie.douban.com/people/4805117/collect?start=180&sort=time&rating=all&filter=all&mode=list'
    ...
    while i < len(link_list):
        ...
        if r.status_code == 200 or r.status_code == 201:
            ...
            if "IMDb链接:" not in infolist:
                ...
                myWrite.writerow([titleMain[0], imdbID, int(yearFormat), rate_list[i][-3]])
                i += 1
