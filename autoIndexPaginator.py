...
url = 'https://movie.douban.com/people/' + username + '/collect?start=0&sort=time&rating=all&filter=all&mode=list'
...
for page in pageRange:
    url = 'https://movie.douban.com/people/' + username + '/collect?start=' + str(page) +\
    ...
    i = 0
    with open('/Users/linnandu/Desktop/WATCHED.csv', 'a', encoding='utf-8') as f:
        ...
        while i < len(link_list):
            ...
            if r.status_code == 200 or r.status_code == 201:
                ...
                if "IMDb链接:" not in infolist:
                    ...
                    with open('/Users/linnandu/Desktop/WATCHED_ERROR.csv', 'a', encoding='utf-8') as fs:
                    ...
                    myWrite.writerow([titleMain, imdbID, int(yearFormat), rate_list[i][-3]])
                    i += 1
